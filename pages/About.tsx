  ...
  return (
    <div className="pt-32 pb-20 px-6 min-h-screen bg-[#050505]">
      <div className="max-w-7xl mx-auto">
        ...
        {/* Contract Vehicles */}
        <section className="bg-white/5 border border-white/10 p-12 text-center rounded-sm">
           <h2 className="text-2xl font-black text-white uppercase tracking-widest mb-6">Contract Vehicles & Certifications</h2>
           <div className="flex flex-wrap justify-center gap-12 text-gray-400 font-black uppercase tracking-tighter text-3xl opacity-40">
              <span>GSA MAS</span>
