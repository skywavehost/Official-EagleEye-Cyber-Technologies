...
import { Globe, Landmark, GraduationCap, Briefcase, Zap, Shield } from 'lucide-react';
          ...
          {INDUSTRIES_DATA.map((industry) => {
            ...
            return (
              ...
              >
                ...
                {/* Grid for Threats and Solutions */}
                ...
                <div className="absolute top-0 right-0 w-20 h-20 opacity-[0.03] group-hover:opacity-[0.08] transition-opacity">
                   <Icon size={80} className="transform translate-x-1/4 -translate-y-1/4" />
                </div>
              </div>
            );
          })}
